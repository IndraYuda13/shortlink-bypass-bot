...
| `https://cuty.io/AfaX6jx` | `cuty.io` | `https://google.com` | live bypass supported for sample | HTTP fast helper solves Turnstile through local solver, replays Cuttlinks final form/timer, and lands on Google; CDP Chrome remains fallback. |
