...
| `cuty.io` | `live_bypass` | `cuty` | `_handle_cuty` | `https://cuty.io/AfaX6jx` | `https://google.com` | HTTP fast helper now returns `https://www.google.com/` via Cuttlinks form replay + local Turnstile solver; CDP browser remains fallback. |
